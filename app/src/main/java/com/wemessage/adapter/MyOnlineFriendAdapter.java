...
public class MyOnlineFriendAdapter extends RecyclerView.Adapter<MyOnlineFriendAdapter.Holder> {
    Activity context;
    ArrayList<String> list;
    DatabaseReference userRef;
    public MyOnlineFriendAdapter(Activity context, ArrayList<String> list) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("myFriendId", list.get(position));
